...
void radioConfigure(UINT32 dataRate, UINT32 frequency) {
    ...
    if (PARTNUM == PARTNUM_CC1110) {
        ...
        default:
            //PA_TABLE0 = 0xC0;           //10 dBm
            PA_TABLE0 = 0x8E;           //0 dBm
            FREQ2 = 0x23;
            FREQ1 = 0x31;
            FREQ0 = 0x3B;
            break;
        ...
        case DATA_RATE_1_CC1110:
            ...
            //AGCCTRL2 = 0x5B;   // AGC control. rssi threshold -85dBm 
            AGCCTRL2 = 0x53;    // rssi threshold -87dbm
        ...
        case FREQUENCY_5_CC2510:        // 2433 MHz
            FREQ2 = 0x5D;
            FREQ1 = 0x93;
            FREQ0 = 0xB1;
            break;
            
         case FREQUENCY_6_CC2510:        // 2400 MHz
            FREQ2 = 0x5C;
            FREQ1 = 0x4E;
            FREQ0 = 0xC3;
            break;
        ...
        case DATA_RATE_2_CC2510:
            ...
            FOCCFG   = 0x1D;   // Frequency Offset Compensation Configuration.
            BSCFG    = 0x1C;   // Bit synchronization Configuration.
            //AGCCTRL2 = 0x5B;   // AGC control. // default magnitude 33, threshold 85, absolute 0, relative disableAGC control.
            AGCCTRL2 = 0xDB;   // AGC control. // default magnitude 33, threshold 73, absolute 0, relative disableAGC control.
            AGCCTRL1 = 0x00;   // AGC control.
            AGCCTRL0 = 0xB2;   // AGC control.
            FSCAL3   = 0xEA;   // Frequency synthesizer calibration.
            FSCAL2   = 0x0A;   // Frequency synthesizer calibration.
