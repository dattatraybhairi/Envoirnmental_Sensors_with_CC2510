...
*
* @brief
*      This function initialize DMA for transmit or receive with various length
*
* Parameters:
* 
* @para BYTE currentMode
*       Transmit mode or receive mode
*       
*       BYTE length
*       length of data to be send or received
*
*       BYTE channel
*       Initialize Channel for RX/TX
*
* @return void
*
******************************************************************************/
void DMAConfig(BYTE currentMode,BYTE length)
{
   PACKET_LENGTH = length;
   dmaRadioSetup(currentMode);
   mode = currentMode;
  // CHANNR = channel;
}
...
*
* @brief
*      This function Arm DMA and sends correspoding stobes depending on mode 
*       either TX or RX
*
* Parameters:
* 
* @para BYTE currentModeVal
*       Transmit mode or receive mode
*       
* @return void
*
******************************************************************************/
void DMACurrentMode(BYTE currentModeVal)
{
  if(currentModeVal == RADIO_MODE_RX)
  {
    DMAARM = 0x83;
