...
//#define      // Payload length. Does not include
...
#define FREQUENCY_5_CC2510      2433000
#define FREQUENCY_6_CC2510      2400000
...
extern BYTE radioPktBuffer[80];  // Buffer for packets to send or receive,
                                                // sized to match the receiver's needs

//mode for the rx or tx in the interrupt
extern BYTE mode;
...
extern void DMAConfig(BYTE currentMode,BYTE length);
extern void DMACurrentMode(BYTE currentModeVal);
...
/* See util_lcd_logo.c for description */
