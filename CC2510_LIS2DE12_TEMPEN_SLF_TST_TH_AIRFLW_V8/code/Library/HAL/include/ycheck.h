...
/* __8051ABI_PORTABILITY_INTERNAL_LEVEL
 *
 * Note: Redefined each time ycheck.h is included, i.e. for each
...
#ifdef __8051ABI_PORTABILITY_INTERNAL_LEVEL
  #undef __8051ABI_PORTABILITY_INTERNAL_LEVEL
#endif


#ifdef _8051ABI_PORTABILITY_LEVEL

  /* The user can define this in the source code before including
   * a standard header. */
  #define __8051ABI_PORTABILITY_INTERNAL_LEVEL _8051ABI_PORTABILITY_LEVEL

#elif defined(__8051ABI_PORTABILITY_LEVEL)

  /* The user can define this in the source code before including
   * a standard header. */
  #define __8051ABI_PORTABILITY_INTERNAL_LEVEL __8051ABI_PORTABILITY_LEVEL

#elif defined(__DEFAULT_8051ABI_PORTABILITY_LEVEL)

  /* The tool chain defines this if the project has enabled abi
   * portability. */
  #define __8051ABI_PORTABILITY_INTERNAL_LEVEL __DEFAULT_8051ABI_PORTABILITY_LEVEL

#else
  #define __8051ABI_PORTABILITY_INTERNAL_LEVEL 0
#endif
