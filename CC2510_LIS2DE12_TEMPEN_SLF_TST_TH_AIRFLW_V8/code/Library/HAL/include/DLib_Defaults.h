 ...
 */
...
#ifndef _DLIB_SUPPORT_FOR_8051ABI
  #ifdef __EDG_IA64_ABI
    #define _DLIB_SUPPORT_FOR_8051ABI 1
  #else
    #define _DLIB_SUPPORT_FOR_8051ABI 0
  #endif
#endif

#if _DLIB_SUPPORT_FOR_8051ABI == 1 
   ...
   * the symbol _DLIB_8051ABI_DIFUNC_CONTAINS_OFFSETS is true, each
   * entry in the table is encoded as an offset from the entry
   * location. When false, the entries contain the actual addresses to
   * call.
   */
  #ifndef _DLIB_8051ABI_DIFUNC_CONTAINS_OFFSETS
    #define _DLIB_8051ABI_DIFUNC_CONTAINS_OFFSETS 1
  #endif
#endif /* _DLIB_SUPPORT_FOR_8051ABI == 1  */
