...
/* Used to refer to '__8051abi' symbols in the library. */ 
#define _ABINAME(x) _GLUE_B(__8051abi_, x)
...
#if __8051ABI_PORTABILITY_INTERNAL_LEVEL && !_DLIB_SUPPORT_FOR_8051ABI
  #error "__8051ABI_PORTABILITY_LEVEL != 0 needs a library built with _DLIB_SUPPORT_FOR_8051ABI turned on"
#endif
...
_END_EXTERN_C
...
#if _DLIB_SUPPORT_FOR_8051ABI && !_DLIB_MBSTATET_USES_UNSIGNED_LONG
  typedef struct
  ...
  #endif
#else /* _DLIB_SUPPORT_FOR_8051ABI */
  typedef struct
  {       /* state of a multibyte translation */
...
#endif /* _DLIB_SUPPORT_FOR_8051ABI */
